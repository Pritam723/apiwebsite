...
class TransmissionElementAvailability(StandardInterface):
    __tablename__ = "TransmissionElementAvailability"

    @classmethod
    def get_upload_path(cls):
        return "\System Operation\Transmission Element Availability"
    ...
    def get_filters_in_use(cls):
        FILTERS_IN_USE = { "Date Range": False, "Year": True, "Month": True, "Financial Year": True, "Financial Year & Quarter": False}
