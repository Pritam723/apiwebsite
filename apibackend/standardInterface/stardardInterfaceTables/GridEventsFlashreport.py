...
class GridEventsFlashreport(StandardInterface):
    __tablename__ = "GridEventsFlashreport"

    @classmethod
    def get_upload_path(cls):
        return "\Reports\Grid Events Flash Report"
    ...
    def get_sort_in_use(cls):
        SORT_IN_USE = { "id": False, "fileName": True, "fileDate": False, "weekStartsEnds": False, "month": False, "quarter": False, "year": False,
                        "fy": True, "fileDateFromTo": False, "uploadedOn": True, "uploadedBy": False, "actualUploadDate": False, "size":False }
        return SORT_IN_USE
    
    @classmethod
    def get_filters_in_use(cls):
        FILTERS_IN_USE = { "Date Range": False, "Year": True, "Month": False, "Financial Year & Quarter": True}
