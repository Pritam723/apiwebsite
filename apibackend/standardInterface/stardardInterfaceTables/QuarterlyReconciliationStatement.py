...
class QuarterlyReconciliationStatement(StandardInterface):
    __tablename__ = "QuarterlyReconciliationStatement"

    @classmethod
    def get_upload_path(cls):
        return "\Market Operation\Metering\Quarterly Reconciliation Statement"
