...
class VDIDaily(StandardInterface):
    __tablename__ = "VDIDaily"

    @classmethod
    def get_upload_path(cls):
        return "\Reports\Voltage Deviation Index\VDIDaily"
    ...
    def get_filters_in_use(cls):
        FILTERS_IN_USE = { "Date Range": True, "Year": False, "Month": True, "Financial Year": True, "Financial Year & Quarter": False}
