...
currentUser = "00091"
targetClass = "DailyPSPReport"    
dest_path_db = "Reports\Daily Report\Daily PSP Report"
...
source = "\\\\10.3.100.24\\HTTP-Access\\Control_Room_Report\\PSP\\{}\\{}\\".format(year, month_display) + src_fileName
...
destination_dir = os.path.join(
    project_root,
    "uploads", "Reports", "Daily Report", "Daily PSP Report"
)
